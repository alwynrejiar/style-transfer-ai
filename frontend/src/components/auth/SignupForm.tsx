  ...
  return (
    <div className="w-full max-w-[420px] mx-auto">
      <div className="rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl p-8">
        ...
        <p className="text-white/50 text-sm text-center mt-1 mb-6">Get started with Stylomex.AI</p>
        ...
        <p className="text-center text-sm text-white/40 mt-6">
          ...
          <Link href="/login" className="text-white hover:text-white/80 underline underline-offset-4 transition-colors">
            Sign in
          </Link>
        </p>
      </div>
